...
| 附加功能 | 关卡选择、提示高亮、辅助线、缩放拖动、日夜模式、计分与历史得分、打包成免安装 exe |
...
下面这张是开发过程中保留下来的对话截图：我提出“难度还是不够，思考量太低了，你可以在
某一步的时候留唯一解或二解”，Codex 就按“每一步还剩几个可选箭头”重新统计了整局，把
难度从“箭头多”改成“可选分支收窄”，并列出了唯一解的步骤数。

![与 Codex 讨论关卡难度的对话记录](assets/aigc-level-design-dialog.png)
